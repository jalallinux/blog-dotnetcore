...
public class UserStoreRequest: IValidatableObject
{
    [Required]
    [StringLength(100)]
    ...
    [Required]
    public Entities.Models.User.GenderType Gender { get; set; }
    ...
    public IEnumerable<ValidationResult> Validate(ValidationContext validationContext)
    {
        ...
        if (Gender == Entities.Models.User.GenderType.Male && Age > 30)
